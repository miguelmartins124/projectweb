...
<?php
      ...
      while($linha = $resultado->fetch_assoc()){//vai buscar os resultados da query e coloca-os na variável linha
        $nome=$linha['uidUsers'];
          ...
          header("location:index.php");//volta à pagina do index
      }if(isset($_SESSION['nivel'])){//consoante o conteúdo da variável nivel, o inicio de sessão tem diferentes homepages
          if($_SESSION['nivel'] == "c"){
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="horario.php">Consultar Sumário</a>
                  </li>
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="../../cadeiras/cadeiras.php">Álgebra</a>
                      <a class="dropdown-item" href="../../cadeiras/cadeiras.php">Sinais e Sistemas</a>
                      <a class="dropdown-item" href="../../cadeiras/cadeiras.php">Matemática 1</a>
